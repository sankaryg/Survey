...
public class GameActivity extends Activity {
	...
	public void gameEnd() {
		...
		Intent inte = new Intent(getApplicationContext(), GameEnd.class)
	...
	protected void onRestart() {
		// TODO Auto-generated method stub
		super.onRestart();
		preference.edit().putBoolean("restart", true).commit();
		/*
		 * if(tmgr != null) { tmgr.listen(listener,
		 * PhoneStateListener.LISTEN_CALL_STATE); } if(!paused) game.resume();
		 */
	}
	...
	protected void onPause() {
		...
		paused = false;
		game.pause();
		preference.edit().putBoolean("restart", false).commit();
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK
			...
			/*
			 * paused = true; game.pause(); AlertDialog.Builder alert = new
			 ...
			 * Auto-generated method stub game.timerpause = false;
			 * //game.timer.setPaused(false); //game.timer.onFinish();
			 * //game.timer.cancel(); game.stop(); finish();
			 * 
			 * } }); alert.setNegativeButton("Cancel", new
			 * DialogInterface.OnClickListener() {
			 * 
			 * public void onClick(DialogInterface arg0, int arg1) { // TODO
			 * Auto-generated method stub Toast.makeText(GameActivity.this,
			 * "cancel clicked", Toast.LENGTH_SHORT).show(); Log.d("Update",
			 * "cancel called"); game.resume(); paused = false; } });
	...
	public void openDialog() {
		 ...
		 * game.resume(); paused = false; Constants.threeBalloons = false;
		 * coin_rotate = null; } });
		 */
		dialog.show();
		/*
		 * Constants.finishbonus = false; timer = new CountDownTimer(60000,1000)
		 * {
		 * 
		 ...
		 * //Constants.finishbonus = true; timer.cancel();
		 * if(coin_rotate!=null){ coin_rotate.stop(); coin_rotate = null; }
		 * //handler.sendEmptyMessage(1); if (handler != null)
		 * handler.removeCallbacks(pushTask); game.resume(); paused = false;
		 * Constants.threeBalloons = false; if (dialog != null)
		 * dialog.dismiss(); dialog.hide(); } }; timer.start();
		 */
		if (handler == null)
			handler = new Handler();
	...
	private Runnable pushTask = new Runnable() {
		...
		public void run() {
			...
			/*
			 * if(coin_rotate!=null) coin_rotate.cleanup();
			 */
			// if(coin_rotate!=null){
